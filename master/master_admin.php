...
<head>
  ...
  <meta name="description" content="AL Technology">
  <meta name="author" content="ahmad muharik al ansori">
  ...
  <link rel="shortcut icon" href="images/load.png">
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-danger fixed-top" id="mainNav">
    <a class="navbar-brand" href="master.php">Rental Manga</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav bg-danger" id="exampleAccordion">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Rental Manga</li>
      </ol>
      <div class="row">
        <div class="col-12">
    ...
    <footer class="sticky-footer">
      <div class="container">
        <div class="text-center">
          <small>Copyright © Rental Manga 2023</small>
        </div>
      </div>
    </footer>
